...
const Blog = ({ id, link, imageurl, text }) => {
  ...
  return (
    <div className="mb-5 md:mb-7 relative" onClick={handleClick}>
      <div>
        ...
        />
        {showText && (
          <div className="absolute top-0 left-0 text-center md:p-4 w-full h-full bg-[#1363DF] opacity-90 flex justify-center items-center transition-opacity">
